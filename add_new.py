...
class addstu(Screen):
    ...
    def sub(self, butt):
        ...
        db.child("studentdata").child(sd["name"])._set(sd)
    ...
    def __init__(self):
        super(addstu, self).__init__()
        self.name = "adp"
        self.add_widget(Image(source="student data.jpg", pos_hint={"top": 1.1, "right": 1.3}))
        self.mylbl = Label(text="Enter new student details", size_hint=(0.5, 0.35), pos_hint={"top": 0.9, "right": 0.6},
